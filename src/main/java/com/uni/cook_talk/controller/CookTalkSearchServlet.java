...
/**
 * Servlet implementation class CookTalkSearchServlet
 */
@WebServlet("/cookTalkSearch.do")
public class CookTalkSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CookTalkSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Cook_Talk> list = new CookTalkService().searchCookTalk(cks, pi); //게시판 목록 호출
		System.out.println("=========================검색================================"+list);
		request.setAttribute("list", list);
		request.setAttribute("pi", pi);
		request.getRequestDispatcher("views/cook_talk/cookTalkList.jsp").forward(request, response);
	}
